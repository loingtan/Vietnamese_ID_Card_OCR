...
class MongoDBClient:
    ...
    def _create_indexes(self):
        ...
        results_collection.create_index("image_filename")
        results_collection.create_index("success")
    ...
    async def _create_indexes_async(self):
        ...
        await results_collection.create_index("image_filename")
        await results_collection.create_index("success")
    ...
    def get_ocr_results_count(self, filter_criteria: Dict[str, Any] = None) -> int:
        """
        Get the total count of OCR results in the database with optional filtering.
    ...
    async def get_ocr_results_count_async(self, filter_criteria: Dict[str, Any] = None) -> int:
        """
        Get the total count of OCR results in the database with optional filtering (async).
